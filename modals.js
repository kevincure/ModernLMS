    ...
    <div class="modal-overlay" id="aiCourseSetupModal">
      <div class="modal" style="max-width:700px;max-height:90vh;display:flex;flex-direction:column;">
        ...
        <div class="modal-body" id="aiSetupWizBody" style="flex:1;overflow-y:auto;padding:16px 20px;">
          <!-- Wizard step content rendered dynamically -->
        </div>
        <div class="modal-footer" id="aiSetupWizFooter" style="flex-shrink:0;">
          <button class="btn btn-secondary" onclick="aiSetupClose()">Cancel</button>
          <button class="btn btn-primary" onclick="aiSetupNextStep()">Continue</button>
        </div>
      </div>
    </div>
  `);
