...
// ═══════════════════════════════════════════════════════════════════════════════
// DEVELOPER TODOS
// Future integrations and features to implement
// ═══════════════════════════════════════════════════════════════════════════════
...
export const DEV_TODOS = [
  ...
  {
    id: 'pangram-turnitin',
    title: 'Pangram AI / Turnitin Integration',
    description: 'Integrate with Pangram AI or Turnitin for AI-generated content detection and plagiarism analysis on student submissions.',
    priority: 'high',
    category: 'ai'
  },
  ...
  {
    id: 'autograding',
    title: 'Autograding Integration',
    description: 'Support automated grading for code submissions (e.g., Gradescope, custom test runners). Define test cases per assignment, run against submissions, return scores automatically.',
    priority: 'high',
    category: 'grading'
  },
  ...
  {
    id: 'common-cartridge',
    title: 'Common Cartridge (IMS CC) Transfer',
    description: 'Import and export courses in IMS Common Cartridge format for compatibility with Canvas, Blackboard, Moodle, and other LMS platforms.',
    priority: 'medium',
  ...
  {
    id: 'file-text-for-ai',
    title: 'Process File Text for AI Context',
    description: 'Extract and index text from uploaded files (PDF, DOCX, TXT) so the AI assistant can answer questions about course materials. Requires server-side text extraction or a client-side PDF.js parser.',
    priority: 'high',
    category: 'ai'
  },
  ...
  {
    id: 'wcag-remediation',
    title: 'Full WCAG 2.1 AA Remediation',
    description: [
      'Add focus-visible outlines to all interactive elements',
      'Add aria-describedby to form inputs with hints',
      'Add role="alert" to toast notifications (partially done)',
      'Ensure color contrast ratios meet 4.5:1 for normal text, 3:1 for large text',
      'Add keyboard navigation for toolbar (arrow key movement between buttons)',
      'Add aria-expanded to dropdown toggles',
      'Ensure modal focus trap includes all interactive elements',
      'Add captions/transcripts for video embeds'
    ].join('; '),
    priority: 'medium',
